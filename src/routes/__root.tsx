...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "TooliVerse — Automating work. Amplifying productivity." },
      { property: "og:description", content: "AI-powered workplace productivity suite for email writing, meeting summaries, task planning, and research." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "TooliVerse — Automating work. Amplifying productivity." },
      { name: "twitter:description", content: "AI-powered workplace productivity suite for email writing, meeting summaries, task planning, and research." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/1a20dca5-7cc3-4a7c-9430-a30cf1213c67" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/1a20dca5-7cc3-4a7c-9430-a30cf1213c67" },
    ],
